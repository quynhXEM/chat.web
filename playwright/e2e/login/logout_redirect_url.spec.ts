...
Copyright 2023 The SOC Foundation C.I.C.
...
test.use({
    config: {
        // We redirect to decoder-ring because it's a predictable page that isn't SOC Connect itself.
        ...
        // `test-landing.html` page when running with an uncontrolled SOC Connect (via `yarn start`).
