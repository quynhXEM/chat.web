...
/** Visit the login page, choose to log in with "OAuth test", register a new account, and redirect back to SOC Connect
 */
export async function doTokenRegistration(
    ...
    // Synapse prompts us to grant permission to SOC Connect
